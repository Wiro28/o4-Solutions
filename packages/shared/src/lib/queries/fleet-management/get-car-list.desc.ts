...
export const GetCarListDesc: QueryDescription = {
  name: 'FleetManagement.GetCarList',
  returnType: 'FleetManagement.Car.CarList',
  ...
  _pbLastUpdatedAt: '2024-06-28T09:15:49.536Z',
  _pbVersion: 3,
  _pbLink:
